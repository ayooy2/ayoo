...
function simpleMD(md) {
  ...
  for (var n = 0; n < cbs.length; n++) {
    ...
    var html = '<div class="code-block-wrapper"><div class="code-block-bar" onclick="var b=this.nextElementSibling;b.classList.toggle(\'hidden\');this.parentElement.classList.toggle(\'folded\')">' +
