...
function rc(list,d){
  ...
  for(var i=0;i<list.length;i++){
    var c=list[i];
    var avatar=c.avatar_url||"https://cravatar.cn/avatar?d=mp&s=48";
    if(avatar.indexOf("cravatar.cn/avatar?")>0&&_cEmail&&c.author_name===_cName){avatar=gravatar(_cEmail);}
    var nameHtml=c.url
    ...
    h+='<img class="comment-avatar" src="'+avatar+'" alt="" loading="lazy" onerror="this.src=&quot;https://cravatar.cn/avatar?d=mp&amp;s=48&quot;">';
...
function gravatar(email){if(!email)return"https://cravatar.cn/avatar?d=mp&s=48";return"https://cravatar.cn/avatar/"+md5c(email.trim().toLowerCase())+"?d=mp&s=48";}
