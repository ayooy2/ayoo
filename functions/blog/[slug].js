...
function simpleMD(md) {
  ...
  for (var n = 0; n < cbs.length; n++) {
    ...
    var html = '<div class="code-block-wrapper"><div class="code-block-bar" onclick="var w=this.parentElement;var b=w.querySelector(\'.cb-body\');b.classList.toggle(\'hidden\');w.classList.toggle(\'folded\')">' +
      '<span class="code-block-lang">' + l + ' <span class="lang-arrow">&#8964;</span></span>' +
      '<span style="flex:1"></span>' +
      '<button class="code-block-btn" data-a="copy" title="复制" onclick="event.stopPropagation()"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="9" y="9" width="13" height="13" rx="2"/><path d="M5 15H4a2 2 0 01-2-2V4a2 2 0 012-2h9a2 2 0 012 2v1"/></svg></button>' +
      '<button class="code-block-btn" data-a="fullscreen" title="全屏" onclick="event.stopPropagation()"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="15 3 21 3 21 9"/><polyline points="9 21 3 21 3 15"/><line x1="21" y1="3" x2="14" y2="10"/><line x1="3" y1="21" x2="10" y2="14"/></svg></button>' +
