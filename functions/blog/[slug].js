...
function retroAv(seed){return"https://api.dicebear.com/7.x/pixel-art-neutral/svg?seed="+encodeURIComponent(seed)+"&size=48";}

function rc(list,d){
  d=d||0;var h="";
  for(var i=0;i<list.length;i++){
    var c=list[i];
    var avatarHash=c.avatar_hash||"";
    ...
    h+='<img class="comment-avatar" src="'+avatar+'" alt="" loading="lazy">';
...
function gravatar(email){if(!email)return"";return md5c(email.trim().toLowerCase());}
